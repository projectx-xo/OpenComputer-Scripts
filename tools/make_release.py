...
FILES = [
    'central/central.lua', 'central/hologram.lua', 'central/site_intel.lua', 'central/nuclear.lua', 'central/fleet_update.lua', 'bootstrap/bootstrap.lua', 'runtime/manifest.lua',
